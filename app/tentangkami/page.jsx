      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 lg:px-12 py-8">
        ...
        <div className="flex justify-center">
          <p>
            ...
            memastikan setiap kue yang kami buat memiliki rasa yang autentik dan
            tak terlupakan. Selain itu, kami juga terus berinovasi dengan
        ...
        <div className="flex justify-center">
          <p>
            ...
            acara, seperti ulang tahun, pernikahan, dan perayaan lainnya, untuk
            membuat momen spesial Anda semakin berkesan.
          </p>
        </div>
      </div>
      <div className="flex justify-center items-center h-full">
        <p className="text-center">
          Terima kasih telah mempercayakan kebutuhan kue Anda kepada Rano Cake.
          Kami akan terus berusaha memberikan yang terbaik dan menjadi bagian
          dari setiap momen istimewa Anda.
        </p>
      </div>
    </div>
  );
